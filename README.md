...
正式執行入口是 [`SKILL.md`](SKILL.md)，完整繁體中文閱讀版位於 [`references/zh-TW.md`](references/zh-TW.md)。英文 `SKILL.md` 是唯一正式執行入口。

## Install in Codex / 安裝到 Codex
...
### Windows quick install / Windows 快速安裝
...
The validator should report `Skill is valid!`。驗證器應回報 `Skill is valid!`。

## Included teaching materials / 內附教學教材

- [`assets/Game-Design-Skill-教學簡報.pptx`](assets/Game-Design-Skill-教學簡報.pptx) — teaching presentation / 教學簡報
- [`assets/Game-Design-Skill-課程學習任務與學習單.docx`](assets/Game-Design-Skill-課程學習任務與學習單.docx) — course tasks and worksheet / 課程任務與學習單
- [`references/course-learning-tasks.md`](references/course-learning-tasks.md) — Markdown teaching guide / Markdown 教學指南
- [`assets/student-worksheet.md`](assets/student-worksheet.md) — student worksheet / 學生工作表
- [`assets/instructor-rubric.md`](assets/instructor-rubric.md) — instructor rubric / 教師評分規準

## Companion capabilities / 配套能力
...
本 Skill 可依任務需要搭配 Sites、視覺化、影像生成、Remotion、SVG/CSS/canvas 與瀏覽器測試等能力。背景音樂與音效應使用具授權的素材或使用者提供的素材；若環境提供合適的音訊生成能力，也可以依授權與來源規則使用。

## Copyright and attribution / 著作權與署名
